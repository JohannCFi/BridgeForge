// ============================================================
// BridgeForge – XRPL Wallet Hook
// Connects via Crossmark or GemWallet browser extensions.
// Burn = send tokens back to the issuer (Payment tx).
// ============================================================

import { useState, useCallback } from "react";
import type { ChainWallet, BurnParams } from "./useWallet";

// XRPL currency code for tEURCV (40-char hex)
const CURRENCY_CODE = "7445555243560000000000000000000000000000";

export function useXrplWallet(): ChainWallet {
  ...
  const signBurn = useCallback(
    async (params: BurnParams): Promise<string> => {
      ...
      if (activeWallet === "crossmark") {
        ...
        // res.response.data.resp is a TxResponse from xrpl
