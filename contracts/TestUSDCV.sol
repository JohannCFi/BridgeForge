...
/**
 * @title TestUSDCV
 * @notice Mock ERC-20 token simulating SG Forge's USDCV for the BridgeForge POC.
 *
 ...
 */
contract TestUSDCV is ERC20, Ownable {
    uint8 private constant DECIMALS = 6; // Same as USDC/USDCV
    ...
    constructor() ERC20("Test USD CoinVertible", "tUSDCV") Ownable(msg.sender) {}
     ...
     * Anyone holding tUSDCV can burn to initiate a bridge transfer.
     */
