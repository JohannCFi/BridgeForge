...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface TestEURCVInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "balanceOf" | "bridgeBurn" | "burn" | "decimals" | "mint" | "name" | "owner" | "renounceOwnership" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "BridgeBurn" | "OwnershipTransferred" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'allowance', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'bridgeBurn', values: [BigNumberish, string, string]): string;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
    ...
    export namespace BridgeBurnEvent {
      export type InputTuple = [sender: AddressLike, amount: BigNumberish, destinationChain: string, recipientAddress: string];
      export type OutputTuple = [sender: string, amount: bigint, destinationChain: string, recipientAddress: string];
      export interface OutputObject {sender: string, amount: bigint, destinationChain: string, recipientAddress: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface TestEURCV extends BaseContract {
    
    connect(runner?: ContractRunner | null): TestEURCV;
    waitForDeployment(): Promise<this>;

    interface: TestEURCVInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    bridgeBurn: TypedContractMethod<
      [amount: BigNumberish, destinationChain: string, recipientAddress: string, ],
      [void],
      'nonpayable'
    >
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'BridgeBurn(address,uint256,string,string)': TypedContractEvent<BridgeBurnEvent.InputTuple, BridgeBurnEvent.OutputTuple, BridgeBurnEvent.OutputObject>;
